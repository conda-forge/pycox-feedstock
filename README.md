...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pycox-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13355&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pycox-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pycox` can be installed with:

```
conda install pycox
```

It is possible to list all of the versions of `pycox` available on your platform with:
